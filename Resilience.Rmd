...
score_df$consensus_class = case_when(
  score_df$cacs_riskscorecond_pct < 0.21 ~ "resilient",
  score_df$cacs_riskscorecond_pct > 0.79 ~ "susceptible",
  ((score_df$cacs_riskscorecond_pct > 0.42) & (score_df$cacs_riskscorecond_pct < 0.58))  ~ "reference",
  TRUE ~ "ignore"
)
