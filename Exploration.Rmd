...
ggplot(df_count, aes(fill=stud_class, y=count, x=harm_class)) + 
  ...
  labs(x = "Harmonic Mean Class", y = "Studentised Residuals Class", fill = "Student Class", 
       title = "Class Switching between Score Aggregation Methods (n = 43)")
...
score_df[!score_df$harm_class == score_df$stud_class,] %>%
  ...
  labs(x = "Harmonic Mean Score", y = "ln(CACS)", title = "Participants who switched class in Studentized Residuals (n = 43)", color = "Harmonic Mean Class") +
  geom_point() +
  theme_bw()
